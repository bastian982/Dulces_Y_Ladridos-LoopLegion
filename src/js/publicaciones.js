...
// Función para imprimir una publicación específica
...
const deleteThisPublication = /*async*/(id) => {
  ...
  //reescribir json
  printCards("blog-container",cards(data)); // Vuelve a imprimir las tarjetas sin la publicación eliminada
  console.log(data); // Imprime los datos actualizados en la consola
};
